...
const About = () => {
  return (
    <div className="flex flex-col min-h-screen text-white bg-gradient-to-b from-gray-900 via-black to-gray-900">
      <Navbar/>
      
      <main className="flex-grow">
        <h2 className="my-8 text-4xl font-bold tracking-wide text-center">
          About Us
        </h2>

        <div className="container flex flex-col items-center justify-center gap-12 px-6 m-12 mx-auto mx about-us md:flex-row">
          
          {/* Image Section - Left */}
          <div className="flex justify-center md:w-1/2">
            <img 
              className="transition-transform duration-300 ease-in-out shadow-xl w-80 md:w-96 rounded-2xl hover:scale-105"
