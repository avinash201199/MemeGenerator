        ...
        <nav className="navbar bg-black text-white flex justify-between rounded-full border-1 border-black border-opacity-70 items-center px-10 py-2 shadow-md sticky top-0 z-10">
            ...
            <div className="flex items-center">
                <ul className="nav-links list-none flex items-center">
                    <li className="mr-20">
                        <Link to="/" onClick={() => setMeme && setMeme(null)}>Home</Link>
                    </li>
                    <li className="mr-20">
                        <Link to="/" onClick={() => setMeme && setMeme(null)}>Memes</Link>
                    </li>
                    <li className="mr-20">
                    ...
                    <button 
                        className="theme-toggle ml-4 mr-4"
                        onClick={toggleTheme}
                    >
                    ...
                    <button 
                        className="goback border-none rounded-10 w-16 h-6 items-center justify-center cursor-pointer ml-4 mr-4" 
                        onClick={() => navigate(-1)}
                    >
                        goBack
                    </button>
